...
\begin{frame}\frametitle{Why analyse the quarters separately?}
  ...
  \end{itemize}
  % \to\, run 256145 data is used because it is one of the first runs with the updated SciFi timing alignment. This run is therefore chosen to be used to create V2 alignment
\end{frame}
